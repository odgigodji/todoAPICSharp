        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    ...
                    Description = "Функционал: <br />⁃ Показать все задачи(GET)<br />⁃ Создать задачу(POST)<br />⁃ Показать конкретную задачу(GET - id)" + 
                        "<br />⁃ Редактировать задачу(PUT)<br />⁃ Удалить задачу(DELETE)<br />⁃ Пометить задачу выполненной(PATCH)<br />" +
